   ...
   */
        ...
        Object.defineProperty(this, 'width', {
            ...
            get: function () {
                if (this._internalWidth === undefined) {
                    ...
                    this.animation &&
                    pInst._fixedSpriteAnimationFrameSizes
                ) {
        ...
        this.addAnimation = function (label) {
            ...
            if (typeof label !== 'string') {
                ...
                this._internalHeight =
                    anim.getHeight() * abs(this._getScaleY());
        ...
        this._collideWithOne = function (type, other, callback) {
            ...
            if (type === 'bounce') {
                ...
                other.velocity
                    .sub(otherInitialVelocity)
                    .add(otherFinalVelocity);
            }
    ...
    p5.CollisionShape.prototype.setParentTransform = function (parent) {
        if (parent instanceof Sprite) {
            ...
            throw new TypeError(
                'Bad argument to setParentTransform: ' + parent
            );
        }
        this._onTransformChanged();
    };
